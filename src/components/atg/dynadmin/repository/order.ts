...
export default class OrderRepository extends DynAdmin {
    ...
    async getOrderElementByName(id: string, elementName: string): Promise<NodeList | undefined> {
        const elem: XMLDocument | undefined = await super.getPrintItemsXML(id, this._descriptor)
