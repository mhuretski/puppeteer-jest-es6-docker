...
import { defaultPresenceWaitTimer, defaultToastWaitTimer } from '@const/global/timers'
...
export default class ToastModal extends Rest {
    ...
    async waitSuccessAbsence() {
        return super.waitElementToDisappear(selectors.success, defaultPresenceWaitTimer, defaultToastWaitTimer)
    }
}
