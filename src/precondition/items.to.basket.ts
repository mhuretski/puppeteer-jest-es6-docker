...
export const addToBasketWithToastVerification = async (
    message: string,
    page: AddToBasketInterface,
    toast: ToastModal
) => {
    try {
...
export const addItemToBasketFromPDP = async (pages: PagesMap, relativePathToPDP = defaultPDPPath) => {
