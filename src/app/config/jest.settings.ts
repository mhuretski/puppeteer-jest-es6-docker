import { API_LAUNCH, PERF_LAUNCH, SPEC_LAUNCH, TEST_LAUNCH, UI_LAUNCH } from '@const/properties/init.values'
import { toMatchImageSnapshot } from '@config/screenshot.settings'
import { Browser } from 'puppeteer'
import { CHECK } from '@const/global/flags'

export let browser: Browser
export const checkBrowserConnectionBeforeAll = (browser: Browser, where: string) => {
