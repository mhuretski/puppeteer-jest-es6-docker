...
import { clearDir, createDirIfNotExist, exists, removeFile, renameFile } from './writer'
...
export const clearDownloadFolder = async (pathToFolder = buildSpecificTempDir) => {
...
export const convertPDFToJPG = async (fullPath: string, fileName = defaultFileName) => {
