...
export const [UI_LAUNCH, API_LAUNCH, REST_LAUNCH, SOAP_LAUNCH, SPEC_LAUNCH, PERF_LAUNCH, TEST_LAUNCH] = [
    'UI',
    'API',
    'REST',
    'SOAP',
...
export const [UI_TEST, API_TEST, REST_TEST, SOAP_TEST, SPEC_TEST, PERF_TEST] = [
    'UI',
    'API',
    'REST',
    'SOAP',
...
export const checkFlag = {
    ...
    values: [UI_LAUNCH, API_LAUNCH, REST_LAUNCH, SOAP_LAUNCH, SPEC_LAUNCH, PERF_LAUNCH, TEST_LAUNCH],
}
